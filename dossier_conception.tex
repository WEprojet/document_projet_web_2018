\section{Introduction}
	...
	\begin{paragraphe}
		Ce document aura pour but de décrire les aspects visuels et techniques de notre site. Ainsi, il présentera les différentes intéractions entre les différentes pages que nous avons conceptualisées. Il montrera également sous quelles dispositions pourront être retrouvé les différents éléments de notre site web et les moyens d'y accéder.
	\end{paragraphe}

\section{Charte graphique}

	\begin{paragraphe}
		Notre site aura pour charte graphique un fond beige entre deux bandeaux bleu azur. Ces bandeaux, en haut et en bas de notre age comprendront un bouton dirigeant vers l'accueil de notre site, ainsi qu'un bouton de connexion et d'inscription si l'on n'est pas connecté.
	\end{paragraphe}

	\begin{paragraphe}
		Une barre de recherche sera également présente en dessous du bandeau du haut sur toutes les pages du site, à part celles de connexion, d'inscription et d'administration. Elle permettra de saisir des recherches d'artiste, d'album, de groupe ou de morceau de musique. Le bandeau du bas comprendra des liens légaux de notre site, ainsi que des coordonnées et liens pour nous contacter.
	\end{paragraphe}

	\begin{paragraphe}
		Le style et la taille de la police des caractères normaux seront pour toutes les pages sera \og hurme\_no2-webfont >> et << sans-serif >>, taille par défaut. Les titres seront en gras et auront pour les pages en comportant le style << hurme\_no2-webfont >> et << sans-serif >> et la taille de police 15px.	
	\end{paragraphe}
...
\section{Présentation}
	\subsection{Disposition 1 (layout)}
		...
		\image{0.5}{images/dossier_conception_mockup_1_layout_1}{Page disposition 1}
...
\section{Définition des pages}
	...
	\subsection{Pages publics}
		\subsubsection{Page accueil}
			...
			\image{0.1}{images/dossier_conception_mockup_1_layout_1}{Page disposition 1}
