...
{Introduction}
	...
	\begin{paragraphe}
		Ce document a pour but de décrire les aspects visuels et techniques de notre site. Ainsi, il présente les différentes intéractions entre les différentes pages conceptualisées. Il montre également sous quelles dispositions peuvent être retrouvées les différents éléments de notre site web et les moyens d'y accéder.
	\end{paragraphe}

\section{Charte graphique}

	\begin{paragraphe}
		Notre site a pour charte graphique un fond beige entre deux bandeaux bleu azur. Ces bandeaux, en haut et en bas de notre age comprennent un bouton dirigeant vers l'accueil de notre site, ainsi qu'un bouton de connexion et d'inscription si l'on n'est pas connecté.
	\end{paragraphe}
